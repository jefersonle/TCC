			...
			<div class="category-list">
				<div id="parentVerticalTab">
					<ul class="resp-tabs-list hor_1">						
						...
						<li id="estadosLink" class="active resp-tab-active" onclick="location.href = '{{url("/admin/estados")}}';">Estados</li>
								     ...
								     <h3 class="head-top">Estados</h3>								       
									    <div class="col-md-12 page_1">		
									    	<div class="view-controls-list" id="viewcontrols">
													<h3><a href="{{url('/admin/estados/create')}}"><span class="label label-primary">Novo Estado</span></a></h3>
												</div>	
												@if(session()->has('msg'))
