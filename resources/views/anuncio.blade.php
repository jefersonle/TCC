		...
		<div class="container">
			<div class="select-box">
				<div class="select-city-for-local-ads ads-list">
					<label>Selecione sua cidade para ver anúncios locais</label>
						<select>
												<optgroup label="Popular Cities">
													<option selected style="display:none;color:#eee;">Todo o Brasil</option>
			...
			<ol class="breadcrumb" style="margin-bottom: 5px;">
			  ...
			  <li class="active">{{ $anuncios[0]->categoria->nome}}</li>
			</ol>
			<div class="ads-grid">
